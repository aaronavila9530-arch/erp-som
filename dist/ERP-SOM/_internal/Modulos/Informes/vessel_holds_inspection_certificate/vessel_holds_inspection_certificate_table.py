...
from api_client import (
    get_vessel_holds_certificates_api,
    get_vessel_holds_certificate_api,
    update_vessel_holds_certificate_api,
    generate_holds_excel_api
)


class VesselHoldsInspectionCertificateTable(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        ttk.Label(
            top,
            text="Vessel Holds Inspection Certificates",
        ...
        self.actions_menu.add_command(
            ...
            command=self._generate_final_certificate
        )
    ...
    def _on_search(self):
        ...
        try:
            ...
            rows = get_vessel_holds_certificates_api()
    ...
    def _review_selected(self):
        ...
        try:
            ...
            from Modulos.Informes.vessel_holds_inspection.vessel_holds_inspection_certificate_form import (
            ...
            form = VesselHoldsInspectionCertificateForm(self.master)
    ...
    def _generate_excel(self):
        ...
        try:
            ...
            file_bytes = generate_holds_excel_api(record_id)
    ...
    def _generate_final_certificate(self):
        ...
        try:
            ...
            from tkinter import filedialog
            from api_client import generate_vessel_holds_pdf_api

            pdf_bytes = generate_vessel_holds_pdf_api(record_id)

            filepath = filedialog.asksaveasfilename(
                title="Guardar Certificado Final",
                defaultextension=".pdf",
                initialfile=f"holds_inspection_certificate_{record_id}.pdf",
