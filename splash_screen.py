...
class SplashScreen(tk.Toplevel):
    ...
    def __init__(self, parent, callback):
        ...
        # =====================================================
        # LOGO SPLASH (CORREGIDO — SIN RUTA ABSOLUTA)
        # =====================================================
        logo_path = resource_path("assets/msl_logo.png")
        ...
        # =====================================================
        # Estilo Azul Corporativo ProgressBar
        # =====================================================
        style = ttk.Style()
    ...
    # -----------------------------------------------------
    # Pre-render login background (CORREGIDO)
    # -----------------------------------------------------
    def _prepare_login_assets(self):
        ...
        bg_path = resource_path("assets/barco.jpg")
