...
class VesselConditionSurveyWordService:

    TEMPLATE_NAME = "vessel_condition_survey_template.docx"
    ...
    # =========================================================
    # TEMPLATE PATH (NO DEPENDE DE TU PC)
    # =========================================================
    ...
    # =========================================================
    # REPLACE PLACEHOLDERS (BODY / TABLE / HEADER / FOOTER)
    # =========================================================
    ...
    def _build_output_path(self, data: dict):
        ...
        report_number = data.get("report_number") or "VESSEL_CONDITION"
        ...
        return os.path.join(
            temp_dir,
            f"{safe_name}_VESSEL_CONDITION_SURVEY.docx"
        )
