...
class PortCaptancyPresentationService:

    TEMPLATE_ACEROS = "presentation_port_captancy_aceros.docx"
    TEMPLATE_GRANOS = "presentation_port_captancy_granos.docx"
    ...
    def generate_pdf_by_id(self, conn, record_id: int) -> str:
        ...
        docx_path = os.path.join(
            temp_dir,
            f"port_captancy_presentation_{record_id}.docx"
        )
    ...
    def _select_template(self, data: dict):
        ...
        if "acero" in operation or "steel" in operation:
            return self.TEMPLATE_ACEROS

        return self.TEMPLATE_GRANOS


    # =========================================================
    # TEMPLATE PATH (NO LOCAL PATH)
    # =========================================================
