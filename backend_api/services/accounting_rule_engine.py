...
DEFAULT_POSTING_RULES = [
    ...
    },
    {
        ...
        "description": "Cash application against customer receivable. BCR payments split 25 USD as bank fees and post only the net to bank.",
        "debit_account_code": "BANK_BY_CLIENT_RULE",
        "credit_account_code": "1.1.04.01",
        "third_party_policy": "CLIENT_REQUIRED",
        "currency_policy": "PAYMENT_CURRENCY",
        "bank_policy": "BCR_NET_OF_25_USD_BANK_FEE__BAC_FOR_PANDI_EL_SURCO__USER_OVERRIDE",
