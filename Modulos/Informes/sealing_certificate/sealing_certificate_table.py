...
from api_client import (
    get_sealing_certificates_api,
    get_sealing_certificate_api,
    update_sealing_certificate_api,
    generate_sealing_excel_api,
    generate_sealing_pdf_api
)


class SealingCertificatesTable(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        # 🔒 Usuario heredado (consistente ERP)
    ...
    def _on_search(self):
        ...
        try:
            ...
            rows = get_sealing_certificates_api()
    ...
    def _review_selected(self):
        ...
        try:
            ...
            from Modulos.Informes.sealing_certificate.sealing_certificate_form import SealingCertificateForm

            data = get_sealing_certificate_api(record_id)

            self.destroy()

            form = SealingCertificateForm(self.master)
    ...
    def _generate_excel(self):
        ...
        try:
            ...
            file_bytes = generate_sealing_excel_api(record_id)
    ...
    def _generate_pdf(self):
        ...
        try:
            ...
            pdf_bytes = generate_sealing_pdf_api(record_id)

            filepath = filedialog.asksaveasfilename(
                title="Guardar Certificado Final",
                defaultextension=".pdf",
                initialfile=f"sealing_certificate_{record_id}.pdf",
