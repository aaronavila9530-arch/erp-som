...
EXPENSE_PRESETS = [
    ("Alimentacion", "5.1.14", "Gastos por alimentación", "DEDUCTIBLE"),
    ("Supermercado", "5.1.13", "Gastos por supermercado", "DEDUCTIBLE"),
    ("Transporte", "500-001-001-050", "Transporte", "DEDUCTIBLE"),
    ("Combustible", "5.1.08", "Gastos por combustible", "DEDUCTIBLE"),
    ...
    ("Servicios basicos", "5.1.03", "Servicios básicos", "DEDUCTIBLE"),
